    ...
    <Carousel fade classname="carousel_place">
      <Carousel.Item>
        ...
        <Carousel.Caption>
          ...
          <p><center><Button variant="primary" href="/browsepage" className='btn_explore'>Explore</Button></center></p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img
        ...
        <Carousel.Caption>
          ...
          <p><center><Button variant="primary" href="/" className='btn_write'>Write</Button></center></p>
        </Carousel.Caption>
      </Carousel.Item>
      <Carousel.Item>
        <img
