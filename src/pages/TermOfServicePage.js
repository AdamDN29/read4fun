            ...
            <Row>
                <Col md="{60}">
                    <Card className="border-0 rounded shadow-sm">
                        ...
                        <h1 className="title">TermOfServicePage</h1>
                        ...
                        <h4>This is a legally binding agreement. By using the Site or any Services provided in connection 
                        ...
                        <h4>The Company operates online reading services website that accompany such story services.</h4><br></br>
                        <h2 className="title-low">4. YOUR OBLIGATIONS</h2>
                        <h4>By registering or using the Sites and Services in any way, you agree to the following:</h4>
                        <h6>
                        ...
                        <h4>Company imposes certain restrictions on your permissible use of the Site and the Service. You are prohibited from violating or 
                            attempting to violate any security features of the Site or Service, including, without limitation,<br></br></h4>
